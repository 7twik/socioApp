...
const Register = () => {
    ...
    useEffect(() => { // validates username and we have user array in [] so it checks everytime there is a change in username
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // console.log(JSON.stringify(Note?.data));
            ...
            {success ? (
                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit} className="polo">
                        ...
                        <button className='Butto kolo' disabled={!validName || !validPwd || !validMatch ? true : false }>Sign Up</button>
                    </form>
                    <p>
